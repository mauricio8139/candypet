                ...
                <form method="post">
                    <?php
                        if(empty($_POST)){
                            ...
                            $file['date_files']=str_replace(" 00:00:00","",$file['date_files']);
                        }else{
                            $file = $_POST;
                        }
                    ?>
                    <div class="row">
                       ...
                       <div class="col-md-8">
                           <input class="alta" id="date_files" type="date" placeholder="Fecha" name="date_files" value="<?php echo $file['date_files']?>">
                       </div>
                        <div class="col-md-3">
                            <label class="des_alta" for="fname">Inserta descripcion expediente:</label>
                        </div>
                        <div class="col-md-8">
                            <input class="alta" id="dsc_files" type="text" placeholder="Descripcion expediente" name="dsc_files" value="<?php echo $file['dsc_files']?>">
                        </div>
                        <div class="col-md-12">
