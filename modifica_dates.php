        ...
        <body>
            ...
            <div class="col-md-12">
                <form method="post">
                    <?php
                        if(empty($_POST)){
                            $file = $pdo->query("SELECT * FROM $_GET[tabla] WHERE id = $_GET[id]")->fetch(PDO::FETCH_ASSOC);
                            $file['date']=str_replace(" 00:00:00","",$file['date']);
                        }else{
                            $file = $_POST;
                        }
                    ?>
                    <div class="row">
                       ...
                       <div class="col-md-8">
                           <input class="alta" id="reason_appointment" type="text" placeholder="Razon" name="reason_appointment" value="<?php echo $file['reason_appointment']?>">
                       </div>
                        <div class="col-md-3">
                            <label class="des_alta" for="fname">Inserta fecha:</label>
                        </div>
                        <div class="col-md-8">
                            <input class="alta" id="date" type="date" name="date" value="<?php echo $file['date']?>">
                        </div>
                        <div class="col-md-3">
                            <label class="des_alta" for="fname">Inserta numero de citas:</label>
                        </div>
                        <div class="col-md-8">
                            <input class="alta" id="cont_dates" type="text" placeholder="Contador" name="cont_dates" value="<?php echo $file['cont_dates']?>">
                        </div>
