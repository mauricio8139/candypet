        ...
        <body>
            ...
            <div class="col-md-12">
                <form method="post">
                    <?php
                    if(empty($_POST)) {
                        $pet = $pdo->query("SELECT * FROM $_GET[tabla] WHERE id = $_GET[id]")->fetch(PDO::FETCH_ASSOC);
                    }else{
                        $pet = $_POST;
                    }
                    ?>
                    <div class="row">
                       ...
                       <div class="col-md-8">
                           <input class="alta" id="name_pet" type="text" placeholder="Nombre" name="name_pet" value="<?php echo $pet['name_pet']?>">
                       </div>
                        <div class="col-md-3">
                            <label class="des_alta" for="fname">Inserta especie:</label>
                        </div>
                        <div class="col-md-8">
                            <input class="alta" id="specie" type="text" placeholder="Especie" name="specie" value="<?php echo $pet['specie']?>">
                        </div>
                        <div class="col-md-3">
                            <label class="des_alta" for="fname">Inserta raza:</label>
                        </div>
                        <div class="col-md-8">
                            <input class="alta" id="breed" type="text" placeholder="Raza" name="breed" value="<?php echo $pet['breed']?>">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-8">
                            <select class="alta" id="customer_id" name="customer_id">
                                ...
                                foreach ($customer as $custome){
                                    if($pet['customer_id'] === $custome['id']){
                                        echo '<option  selected="selected" value="'.$custome['id'].'">'.$custome['id'].' '.$custome['name'].' '.$custome['last_name'].'</option>';
                                    }else{
